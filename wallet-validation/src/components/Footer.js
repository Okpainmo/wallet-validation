...
function Footer() {
  return (
    <footer className="bg-light">
      <p className="legal">
        Wallet Validation is a platform that is created to improve
        ...
        <strong>Disclaimer:</strong> All logo, brand identities, and any other
        content used in this app, are intellectual properties of their
